...
Start here for deeper Degen Dogs Mission 3 dashboard docs.
...
- [Season 6 SUP reward projections](season6-sup-rewards.md) - compact homepage
  estimate, generated fields, and full time-weighted XP methodology.
...
- [Contributing metrics](contributing-metrics.md)
- [Roadmap](roadmap.md)
- [README restructure notes](readme_restructure_notes.md)
...
- [Archive root](../archive/README.md)
- [Mission 1 archive](../archive/mission1/README.md)
- [Mission 2 archive](../archive/mission2/README.md)
- [Mission 3 archive](../archive/mission3/README.md)
