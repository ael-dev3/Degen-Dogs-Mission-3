...
.bid-history-menu{position:relative;align-self:stretch;flex:0 1 172px;min-width:164px;max-width:100%;margin-inline:auto;font-weight:900;line-height:1.12}
.bid-history-menu summary{list-style:none;cursor:pointer;position:relative;display:flex;min-height:48px;height:100%;flex-direction:column;align-items:center;justify-content:center;text-align:center;gap:2px;border:1.5px solid var(--ink);background:#f3fae8;padding:7px 24px 7px 9px;box-shadow:2px 2px 0 rgba(31,107,59,.18)}
...
.bid-history-list{position:absolute;left:50%;top:calc(100% + 6px);z-index:24;transform:translateX(-50%);width:min(360px,calc(100vw - 32px));max-height:260px;overflow:auto;display:grid;gap:6px;margin:0;padding:8px;list-style:none;border:2px solid var(--ink);background:var(--panel);box-shadow:5px 5px 0 var(--ink);text-align:left}
...
@media (max-width:640px){.bid-history-menu{flex:1 1 auto;min-width:128px}.bid-history-list{width:min(340px,calc(100vw - 20px));box-shadow:3px 3px 0 var(--ink)}}
