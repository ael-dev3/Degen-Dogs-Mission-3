...
[[ "$WATCHER_REQUIRE_CLEAN_TREE" == "0" || "$WATCHER_REQUIRE_CLEAN_TREE" == "1" ]] || fail "MISSION3_WATCHER_REQUIRE_CLEAN_TREE must be 0 or 1"
...
[[ "$WATCHER_REFRESH_TIMEOUT_SECONDS" =~ ^[0-9]+$ ]] || fail "MISSION3_WATCHER_REFRESH_TIMEOUT_SECONDS must be an integer"
if (( WATCHER_REFRESH_TIMEOUT_SECONDS < 60 )); then
...
WATCHER_REQUIRE_CLEAN_TREE="$WATCHER_REQUIRE_CLEAN_TREE" \
WATCHER_REFRESH_TIMEOUT_SECONDS="$WATCHER_REFRESH_TIMEOUT_SECONDS" \
...
env = {
    ...
    "MISSION3_WATCHER_REQUIRE_CLEAN_TREE": os.environ["WATCHER_REQUIRE_CLEAN_TREE"],
    "MISSION3_WATCHER_REFRESH_TIMEOUT_SECONDS": os.environ["WATCHER_REFRESH_TIMEOUT_SECONDS"],
